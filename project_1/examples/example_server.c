/* EXAMPLE TAKEN FROM: https://aticleworld.com/ssl-server-client-using-openssl-in-c/ */
...
void Servlet(SSL* ssl) /* Serve the connection -- threadable */
{
    ...
    //              <\Body>";
    const char *cpValidMessage = "{ 'username' : 'article', 'password' : '123' }";
...
int main(int count, char *Argc[])
{
    ...
    char *portnum;
/*
 * BELOW WRONG: root user required to run server on port #'s <1000. Operate port on 8080 preferred
 */
